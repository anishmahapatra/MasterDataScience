...
# Dropping rows that are NULL that will not be used for calculation 
delete from hero1 
where  row_num < 50;
...
# The default value is hold. We now generate the buy and sell signals
...
# Checking for Hold, Sell and Buy
select get_signal_for_date('2015-09-29') as day_signal; 
select get_signal_for_date('2015-08-24') as day_signal; 
select get_signal_for_date('2015-05-18') as day_signal; 
